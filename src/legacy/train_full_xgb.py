...
joblib.dump(model, "models/full_xgb_model.pkl")
joblib.dump(le_pitch, "models/full_label_encoder.pkl")
joblib.dump(list(X.columns), "models/full_feature_columns.pkl")
print("\nModel saved.")